    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(blank=True, help_text='Fichier vidéo (MP4, AVI, MOV, WMV - 100MB max)', null=True, upload_to='media/video/%Y/%m/', validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['mp4', 'avi', 'mov', 'wmv']), apps.media_files.models.validate_video_size], verbose_name='Fichier vidéo')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.PositiveIntegerField(default=0, help_text="Ordre d'affichage dans le portfolio", verbose_name='Ordre')),
                ('file_size', models.PositiveIntegerField(help_text='Taille du fichier en bytes', verbose_name='Taille du fichier')),
                ('file', models.ImageField(help_text='Image (JPG, PNG, GIF - 15MB max)', upload_to='media/photos/%Y/%m/', validators=[apps.media_files.models.validate_photo_size], verbose_name='Photo')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.PositiveIntegerField(default=0, help_text="Ordre d'affichage dans le portfolio", verbose_name='Ordre')),
                ('file_size', models.PositiveIntegerField(help_text='Taille du fichier en bytes', verbose_name='Taille du fichier')),
                ('file', models.FileField(help_text='Document PDF uniquement (10MB max)', upload_to='media/documents/%Y/%m/', validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['pdf']), apps.media_files.models.validate_document_size], verbose_name='Document')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.PositiveIntegerField(default=0, help_text="Ordre d'affichage dans le portfolio", verbose_name='Ordre')),
                ('file_size', models.PositiveIntegerField(help_text='Taille du fichier en bytes', verbose_name='Taille du fichier')),
                ('file', models.FileField(help_text='Fichier audio (MP3, WAV, OGG, M4A - 25MB max)', upload_to='media/audio/%Y/%m/', validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['mp3', 'wav', 'ogg', 'm4a']), apps.media_files.models.validate_audio_size], verbose_name='Fichier audio')),
                ('duration', models.PositiveIntegerField(blank=True, help_text='Durée en secondes', null=True, verbose_name='Durée')),
                ('artist', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='accounts.artistprofile', verbose_name='Artiste')),
            ],
            options={
